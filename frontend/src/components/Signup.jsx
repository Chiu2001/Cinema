...
import styles from '../styles/Signup.module.css'; // Import your CSS file using a namespace
...
const RegisterForm = () => {
    ...
    return (
        <div className={styles.body}> {/* Use CSS module namespace */}
            <div className={styles.formContainer}> {/* Use CSS module namespace */}
