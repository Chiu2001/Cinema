...
export default function ShowMovieAndTime({ movieId }) {
    ...
    // Click a cinema button to show the showdate buttons
    ...
    // The added fetchShowtimes function, used to fetch and filter showtimes data
                ...
                <div className={styles.showtimes}>
                    ...
                    <div className={styles.showtimeGroup}>
                        {selectedDate && groupedShowtimes.length === 0 && (
                            <p>There are no showtimes for this date. Please select another date.</p>
                        )}
